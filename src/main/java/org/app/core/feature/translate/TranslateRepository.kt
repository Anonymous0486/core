...
//import org.app.core.feature.translate.api.GoogleTranslateClient
//import org.app.core.feature.translate.api.OpenRouterClient
...
//    }
//
//    suspend fun translateByModel(model: AIModel, content: String, sourceLan: String, targetLag: String, displayLanguageName: String) = runIO {
//        when(model) {
//            AIModel.Free -> {
//                val ret = try {
//                    val translated = googleTranslateClient.translate(text = content, fromLang = sourceLan, toLang = targetLag)
//                    translated.ifBlank { "" }
//                } catch (_: Exception) {
//                    ""
//                }
//                if (ret.isBlank()) {
//                    //TODO: Retry with server API
//                    return@runIO translateText(content, targetLag)
//                } else {
//                    return@runIO BaseResponse(status = true, result = TranslateResponse(translate = ret))
//                }
//            }
//            AIModel.Google -> {
//                val ret = mlVisionTranslate(listOf(content), sourceLan, targetLag)
//                if (ret.isNotEmpty()) {
//                    return@runIO BaseResponse(status = true, result = TranslateResponse(translate = ret[0]))
//                } else {
//                    tryGoogleTranslate(content, sourceLan, targetLag)?.let { return@runIO BaseResponse(status = true, result = TranslateResponse(translate = it)) }
//                }
//            }
//            AIModel.DeepSeek -> {
//                val prompt = buildPrompt(content, displayLanguageName)
//                tryOpenRouter(LIST_MODEL_DEEP_SEEK, prompt, 0.1, 4000)?.let { return@runIO BaseResponse(status = true, result = TranslateResponse(translate = it)) }
//                tryGoogleTranslate(content, sourceLan, targetLag)?.let { return@runIO BaseResponse(status = true, result = TranslateResponse(translate = it)) }
//            }
//        }
//
//        return@runIO BaseResponse(status = false)
//    }
//
...
//    }
//
//    fun translateWithFreeGoogleApi(rawText: String, fromLang: String, toLang: String): String {
//        return try {
//            val translated = googleTranslateClient.translate(text = rawText, fromLang = fromLang, toLang = toLang)
//            translated.ifBlank { "" }
//        } catch (_: Exception) {
//            ""
//        }
...
//        maxTokens: Int = 4000,
//        useGoogleFirst: Boolean = false
//    ): String {
//        if (useGoogleFirst) {
//            tryGoogleTranslate(rawText, fromLang, toLang)?.let { return it }
//            tryOpenRouter(models, prompt, temperature, maxTokens)?.let { return it }
//        } else {
//            tryOpenRouter(models, prompt, temperature, maxTokens)?.let { return it }
//            tryGoogleTranslate(rawText, fromLang, toLang)?.let { return it }
//        }
...
//        for (model in models) {
//            try {
//                Timber.tag("Log_Translate").d("Trying OpenRouter model=%s", model)
//                val translated = openRouterClient.translateText(
//                    model = model,
//                    prompt = prompt,
...
//                    Timber.tag("Log_Translate").d("OpenRouter success model=%s", model)
//                    return translated
//                }
//            } catch (e: Exception) {
//                Timber.tag("Log_Translate").w(e, "OpenRouter failed model=%s", model)
//            }
//        }
//
//        return null
//    }
//
//    private fun tryGoogleTranslate(
//        rawText: String,
//        fromLang: String,
//        toLang: String,
//    ): String? {
//        return try {
//            Timber.tag("Log_Translate").d("Trying Google Translate")
//            val translated = googleTranslateClient.translate(text = rawText, fromLang = fromLang, toLang = toLang)
//            if (translated.isNotBlank()) {
//                Timber.tag("Log_Translate").d("Google Translate success")
//                translated
//            } else {
//                null
//            }
//        } catch (e: Exception) {
//            Timber.tag("Log_Translate").w(e, "Google Translate failed")
//            null
//        }
//    }
//
...
//
//    companion object {
//        val LIST_MODEL_FREE = listOf(
//            "google/gemma-3-27b-it:free",
//            "google/gemma-3-4b-it:free",
//            "google/gemma-3n-e4b-it:free"
//        )
//
//        val LIST_MODEL_GOOGLE = listOf(
//            "google/gemma-3-27b-it:free",
//            "google/gemma-3-4b-it:free",
//            "google/gemma-3n-e4b-it:free"
//        )
//
//        val LIST_MODEL_DEEP_SEEK = listOf(
