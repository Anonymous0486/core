...
open class BaseViewModel(application: Application) : AndroidViewModel(application) {
  ...
  private val _hideAds: MutableLiveData<Boolean> = MutableLiveData<Boolean>(false)
  val hideAds: LiveData<Boolean>
    get() = _hideAds
  ...
  fun setHideAd(value: Boolean) {
    _hideAds.postValue(value)
  }
}